...
import customer_2 from "./customer_2.jpg";
import customer_3 from "./customer_3.jpg";

export { logo };
export { logo_min };
export { notFound };
export const wallpapers = [wallpaper_1, wallpaper_2];
export const photos = [photo_1, photo_2, photo_3, photo_4];
