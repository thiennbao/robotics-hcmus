          ...
          <div className="lg:mr-20">
            ...
            <Appear variant="right">
              <p className="mt-4">
                ...
                j&apos;appartiens. Quand il me prend dans ses bras il me parle
                tout bas je vois la vie en rose qu&apos;il me dit des mots
                d&apos;amour des mots de tous les jours et ça me fait quelque
                chose.
              </p>
            </Appear>
            <Appear variant="right">
              <p className="mt-4">
                Il est entré dans mon cœur Une part de bonheur Dont je connais
                la cause C&apos;est lui pour moi Moi, pour lui, dans la vie Il
                me l&apos;a dit, l&apos;a juré pour la vie Et dès que je
                l&apos;aperçois Alors, je sens en moi Mon cœur qui bat.
              </p>
            </Appear>
            <Appear variant="right">
              <p className="mt-4">
                Des nuits d&apos;amour à ne plus en finir Un grand bonheur qui
                prend sa place Des ennuis, des chagrins, s&apos;effacent
